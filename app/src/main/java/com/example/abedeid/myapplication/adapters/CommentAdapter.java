...
public class CommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        }else if (viewType == CommentType.RECEIVE_TXT_IMAGE) {
            return new ReceivedImageTextHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.row_received_message_img_text, parent, false));
        }else if (viewType == CommentType.SENNT_TXT_IMAGE) {
            return new SentImageTextHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.row_sent_message_img_text, parent, false));
        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder mHolder, int position) {
        ...
        if (type == CommentType.SENT_TXT) {
            ...
            Glide.with(context).load(Urls.Local_images + CurrentMessage.user_image).asBitmap().centerCrop().into(new BitmapImageViewTarget(holder.img_profile) {
                @Override
            ...
            Glide.with(context).load(Urls.Local_images + CurrentMessage.image).into(holder.img_msg);
        ...
        }else if(type==CommentType.RECEIVE_TXT_IMAGE){
            final ReceivedImageTextHolder holder = (ReceivedImageTextHolder) mHolder;
            holder.tv_time.setText(CurrentMessage.updatedat);
            holder.tv_username.setText(CurrentMessage.name);
            holder.tv_message_content.setText(CurrentMessage.txt.trim());
            Glide.with(context).load(Urls.Local_images + CurrentMessage.user_image).asBitmap().centerCrop().into(new BitmapImageViewTarget(holder.img_profile) {
                @Override
                protected void setResource(Bitmap resource) {
                    RoundedBitmapDrawable circularBitmapDrawable =
        ...
        }else if(type==CommentType.SENNT_TXT_IMAGE){

            final SentImageTextHolder holder = (SentImageTextHolder) mHolder;
            holder.tv_time.setText(CurrentMessage.updatedat);
            holder.tv_username.setText(CurrentMessage.name);
            holder.tv_message_content.setText(CurrentMessage.txt.trim());
            Glide.with(context).load(Urls.Local_images + CurrentMessage.user_image).asBitmap().centerCrop().into(new BitmapImageViewTarget(holder.img_profile) {
...
//
        if (userID.equals(comment.user_id + "")) {
            Log.d("Ttt t", userID + " ==== " + comment.user_id);
            ...
            if (comment.image == null) {
                ...
                return CommentType.SENT_IMAGE;
                    ...
                    return CommentType.SENNT_TXT_IMAGE;
            }
            ...
            if (comment.image == null) {
                ...
                return CommentType.RECIVE_IMAGE;
                    ...
                    return CommentType.RECEIVE_TXT_IMAGE;
            }
    ...
    public class ReceivedImageTextHolder extends RecyclerView.ViewHolder {
        @BindView(R.id.tv_time)
        TextView tv_time;
        @BindView(R.id.img_msg)
        ImageView img_msg;
        ...
        public ReceivedImageTextHolder(View itemView) {
            super(itemView);
            ButterKnife.bind(this, itemView);
    ...
    public class SentImageTextHolder extends RecyclerView.ViewHolder {
        @BindView(R.id.tv_time)
        TextView tv_time;
        @BindView(R.id.img_msg)
        ImageView img_msg;
        ...
        public SentImageTextHolder(View itemView) {
            super(itemView);
            ButterKnife.bind(this, itemView);
